...
SERVICES = {
    ...
    "0004": Service(
        "Session",
        {
            ...
            #"4100": Characteristic("4100", SonicareValueType.INT8), # read not permitted
            #"4110": Characteristic("4110", SonicareValueType.RAW), # read not permitted
        }
    ),
    "0005": Service(
        "Sensor",
        {
            #"4120": Characteristic("Enable", SonicareValueType.INT16), # read not permitted
            #"4130": Characteristic("Data", SonicareValueType.RAW), # read not permitted
            #"4140": Characteristic("4140", SonicareValueType.RAW), # read not permitted
        }
    ),
    "0006": Service(
        "Brush",
    ...
    "0007": Service(
        "0007",
        {
            ...
            #"4360": Characteristic("4360", SonicareValueType.RAW), #read not permitted
        }
    ),
    "0008": Service(
        "0008",
